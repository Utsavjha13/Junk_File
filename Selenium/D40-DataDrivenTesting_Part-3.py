...
for i in range(2,r+1):
    ...
    maturity=xLUtility.read_data(file, "Sheet1", i, 6)
    if float(maturT.text) == float(maturity):
        currentstatus=xLUtility.write_data(file, "Sheet1", i, 8, "Passed")
        currentstatusfill=xLUtility.green_color_cell(file, "Sheet1", i, 8)
    else:
        currentstatus = xLUtility.write_data(file, "Sheet1", i, 8, "Failed")
        currentstatusfill = xLUtility.red_color_cell(file, "Sheet1", i, 8)
